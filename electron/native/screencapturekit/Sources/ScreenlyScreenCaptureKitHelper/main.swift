...
final class ScreenCaptureRecorder: NSObject, SCStreamOutput, SCStreamDelegate {
	...
	private let sampleQueue = DispatchQueue(label: "app.screenly.sck-helper.samples")
	private let stateQueue = DispatchQueue(label: "app.screenly.sck-helper.state")
...
@main
struct ScreenlyScreenCaptureKitHelper {
