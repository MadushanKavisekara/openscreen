...
export function AnnotationOverlay({
	...
	const renderArrow = () => {
		...
		const color = annotation.figureData?.color || "#3A7DFF";
	...
	return (
		<Rnd
			...
			style={{
				...
				border:
					isSelected && annotation.type !== "blur" ? "2px solid rgba(58, 125, 255, 0.8)" : "none",
				backgroundColor:
					isSelected && annotation.type !== "blur" ? "rgba(58, 125, 255, 0.1)" : "transparent",
				boxShadow:
					isSelected && annotation.type !== "blur" ? "0 0 0 1px rgba(58, 125, 255, 0.35)" : "none",
			}}
			...
			resizeHandleStyles={{
				topLeft: {
					...
					border: isSelected ? "2px solid #3A7DFF" : "none",
					borderRadius: "50%",
					left: "-6px",
					top: "-6px",
					cursor: "nwse-resize",
