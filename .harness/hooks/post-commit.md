...
# Post-commit reminder for Screenly
...
- A one-line suggestion: push the branch, or run `screenly-reviewer` on the diff if you want a quality check before pushing.
